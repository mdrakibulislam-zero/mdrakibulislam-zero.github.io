        ...
        S = function (h, c) {
            ...
            function q(b, g, u, c) {
                a._bind(
                    ...
                    function (a) {
                        ...
                        "mousewheel" == g ? (a.wheelDeltaX && (c.deltaX = -0.025 * a.wheelDeltaX), a.wheelDeltaY && (c.deltaY = -0.025 * a.wheelDeltaY), c.deltaY || c.deltaX || (c.deltaY = -0.025 * a.wheelDelta)) : (c.deltaY = a.detail);
                        return u.call(b, c);
                    },
                    c
                );
            ...
            if ("auto" == this.opt.rtlmode) {
                ...
                "horizontal-tb" == p || "lr-tb" == p || "" == p
                    ...
                    : ((this.isrtlmode = "vertical-rl" == p || "tb" == p || "tb-rl" == p || "rl-tb" == p), (this.isvertical = "vertical-rl" == p || "tb" == p || "tb-rl" == p));
            ...
            this.doRailClick = function (b, g, c) {
                ...
                a.railslocked ||
                    (a.cancelEvent(b),
                    g
                        ? ((g = c ? a.doScrollLeft : a.doScrollTop), (d = c ? (b.pageX - a.railh.offset().left - a.cursorwidth / 2) * a.scrollratio.x : (b.pageY - a.rail.offset().top - a.cursorheight / 2) * a.scrollratio.y), g(d))
                        : ((g = c ? a.doScrollLeftBy : a.doScrollBy), (d = c ? a.scroll.x : a.scroll.y), (b = c ? b.pageX - a.railh.offset().left : b.pageY - a.rail.offset().top), (c = c ? a.view.w : a.view.h), g(d >= b ? c : -c)));
            };
            ...
            this.init = function () {
                ...
                if (!a.ispage || (!e.cantouch && !e.isieold && !e.isie9mobile)) {
                    ...
                    !a.opt.boxzoom ||
                        ...
                        (a.zoom = f(d)),
                        a.zoom.css({ cursor: "pointer", zIndex: a.zindex, backgroundImage: "url(" + a.opt.scriptpath + "zoomico.png)", height: 18, width: 18, backgroundPosition: "0px 0px" }),
                    ...
                    a.ispage
                        ? (m.css({ position: "fixed", top: 0, height: "100%" }),
                          ...
                          a.body.append(m),
                          a.railh && (n.css({ position: "fixed", left: 0, width: "100%" }), n.align ? n.css({ bottom: 0 }) : n.css({ top: 0 }), a.body.append(n)))
                        : (a.ishwscroll
                              ? ("static" == a.win.css("position") && a.css(a.win, { position: "relative" }),
                                (c = "HTML" == a.win[0].nodeName ? a.body : a.win),
                                f(c).scrollTop(0).scrollLeft(0),
                                a.zoom && (a.zoom.css({ position: "absolute", top: 1, right: 0, "margin-right": m.width + 4 }), c.append(a.zoom)),
                                m.css({ position: "absolute", top: 0 }),
                                m.align ? m.css({ right: 0 }) : m.css({ left: 0 }),
                                c.append(m),
                                n && (n.css({ position: "absolute", left: 0, bottom: 0 }), n.align ? n.css({ bottom: 0 }) : n.css({ top: 0 }), c.append(n)))
                ...
                if ("IFRAME" == this.doc[0].nodeName) {
                    var N = function () {
                        ...
                        a.forcescreen = !0;
                        a.isiframe &&
                            ((a.iframe = { doc: f(c), html: a.doc.contents().find("html")[0], body: a.doc.contents().find("body")[0] }),
            ...
            this.onResize = function (b, c) {
                ...
                0 == a.page.maxh
                    ? (a.hideRail(), (a.scrollvaluemax = 0), (a.scroll.y = 0), (a.scrollratio.y = 0), (a.cursorheight = 0), a.setScrollTop(0), a.rail && (a.rail.scrollable = !1))
                    : ((a.page.maxh -= a.opt.railpadding.top + a.opt.railpadding.bottom), (a.rail.scrollable = !0));
                0 == a.page.maxw
                    ? (a.hideRailHr(), (a.scrollvaluemaxw = 0), (a.scroll.x = 0), (a.scrollratio.x = 0), (a.cursorwidth = 0), a.setScrollLeft(0), a.railh && (a.railh.scrollable = !1))
                    : ((a.page.maxw -= a.opt.railpadding.left + a.opt.railpadding.right), a.railh && (a.railh.scrollable = a.opt.horizrailenabled));
                    ...
                    ? ((this.prepareTransition = function (b, c) {
                      ...
                      (this.doScrollPos = function (b, c, d) {
                          ...
                          a.timer = setTimeout(function () {
                              ...
                              0 < k &&
                                  (!a.scrollrunning && a.onscrollstart && a.onscrollstart.call(a, { type: "scrollstart", current: { x: f, y: d }, request: { x: b, y: c }, end: { x: a.newscrollx, y: a.newscrolly }, speed: k }),
                                  e.transitionend
                                      ? a.scrollendtrapped || ((a.scrollendtrapped = !0), a.bind(a.doc, e.transitionend, a.onScrollTransitionEnd, !1))
                                      : (a.scrollendtrapped && clearTimeout(a.scrollendtrapped), (a.scrollendtrapped = setTimeout(a.onScrollTransitionEnd, k))),
                                  (a.timerscroll = { bz: new D(d, a.newscrolly, k, 0, 0, 0.58, 1), bh: new D(f, a.newscrollx, k, 0, 0, 0.58, 1) }),
                                  a.cursorfreezed ||
                          ...
                          function e() {
                              ...
                              2 == b
                                  ? ((a.timer = 0),
                                    ...
                                    d != a.newscrollx || f != a.newscrolly ? a.doScrollPos(d, f) : a.onscrollend && a.triggerScrollEnd())
                                  : (a.timer = v(e) || 1);
                          }
                ...
                if ((c.speedy && d && c.speedy) || f) {
                    ...
                    var p = c.lastscrollx,
                        ...
                        v = function () {
                            ...
                            c.speedx && ((p = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy))), (c.lastscrollx = p), 0 > p || p > a) && (d = 0.1);
                            c.speedy && ((e = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy))), (c.lastscrolly = e), 0 > e || e > t) && (d = 0.1);
