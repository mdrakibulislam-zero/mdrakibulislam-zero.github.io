        ...
        (e.fn.ajaxSubmit = function (t) {
            ...
            function s(r) {
                        ...
                        if (m.extraData)
                            for (var l in m.extraData)
                                m.extraData.hasOwnProperty(l) &&
                                    o.push(
                                        e.isPlainObject(m.extraData[l]) && m.extraData[l].hasOwnProperty("name") && m.extraData[l].hasOwnProperty("value")
                                            ? e('<input type="hidden" name="' + m.extraData[l].name + '">')
                    ...
                    if (!x.aborted && !F) {
                        ...
                        if ((M && M.location.href != m.iframeSrc) || T) {
                            ...
                            x.aborted && (a("upload aborted"), (i = null)),
                                ...
                                "success" === i
                                    ? (m.success && m.success.call(m.context, L, "success", x), S.resolve(x.responseText, "success", x), d && e.event.trigger("ajaxSuccess", [x, m]))
                ...
                if (
                    ...
                    m.iframeTarget
                        ? ((v = e(m.iframeTarget)), (y = v.attr2("name")), y ? (p = y) : v.attr2("name", p))
            ...
            "function" == typeof t && (t = { success: t }),
                ...
                c && (c = (c.match(/^([^#]+)/) || [])[1]),
                (t = e.extend(!0, { url: c, success: e.ajaxSettings.success, type: u || "GET", iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, t));
            var m = {};
        ...
        (e.fn.formToArray = function (t, r) {
            ...
            for (s = 0, m = o.length; m > s; s++)
                if (((f = o[s]), (l = f.name), l && !f.disabled))
                    if (t && i.clk && "image" == f.type) i.clk == f && (a.push({ name: l, value: e(f).val(), type: f.type }), a.push({ name: l + ".x", value: i.clk_x }, { name: l + ".y", value: i.clk_y }));
                    else if (((c = e.fieldValue(f, !0)), c && c.constructor == Array)) for (r && r.push(f), u = 0, d = c.length; d > u; u++) a.push({ name: l, value: c[u] });
                    else if (n.fileapi && "file" == f.type) {
                        r && r.push(f);
                        var p = f.files;
                        if (p.length) for (u = 0; u < p.length; u++) a.push({ name: l, value: p[u], type: f.type });
                        else a.push({ name: l, value: "", type: f.type });
                    } else null !== c && "undefined" != typeof c && (r && r.push(f), a.push({ name: l, value: c, type: f.type, required: f.required }));
            if (!t && i.clk) {
                var h = e(i.clk),
                    v = h[0];
